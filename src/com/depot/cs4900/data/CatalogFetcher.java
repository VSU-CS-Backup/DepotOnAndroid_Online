...
public class CatalogFetcher {
	 ...
	 * @param numResults
	 */
	public CatalogFetcher(String loc, String cui, String rat, int start, int numResults) {
		...
		Log.v(Constants.LOGTAG, " " + CatalogFetcher.CLASSTAG + " location = "
		...
		Log.v(Constants.LOGTAG, " " + CatalogFetcher.CLASSTAG + " request - "
				+ this.request);
